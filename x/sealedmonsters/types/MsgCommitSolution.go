...
func NewMsgCommitSolution(scavenger sdk.AccAddress,
	solutionHash string, solutionScavengerHash string) *MsgCommitSolution {
...
func (msg *MsgCommitSolution) Reset()         { *msg = MsgCommitSolution{} }
func (msg *MsgCommitSolution) String() string { return proto.CompactTextString(msg) }
func (msg *MsgCommitSolution) ProtoMessage()  {}
