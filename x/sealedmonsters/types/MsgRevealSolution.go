...
func (msg *MsgRevealSolution) Reset()         { *msg = MsgRevealSolution{} }
func (msg *MsgRevealSolution) String() string { return proto.CompactTextString(msg) }
func (msg *MsgRevealSolution) ProtoMessage()  {}
